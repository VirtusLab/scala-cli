...
object `bloop-rifle`  extends Cross[BloopRifle](Scala.defaultInternal, Scala.scala3)
...
def asychScalacOptions(scalaVersion: String) =
...
class Options(val crossScalaVersion: String) extends BuildLikeModule {
  ...
  def scalacOptions = T(super.scalacOptions() ++ asychScalacOptions(scalaVersion()))
