...
cs launch org.virtuslab::scala-packager-cli:0.1.7 -- --source-app-path "$LAUNCHER" --output scala-cli.deb --deb
cs launch org.virtuslab::scala-packager-cli:0.1.7 -- --source-app-path "$LAUNCHER" --output scala-cli.rpm --rpm
