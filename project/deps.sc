...
object Scala {
  ...
  def scala3NextRcAnnounced = "3.7.0-RC2" // the latest announced RC version of Scala Next
...
object Deps {
  ...
  def metaconfigTypesafe =
    ivy"org.scalameta::metaconfig-typesafe-config:0.15.0"
