...
object Scala {
  ...
  def maxAmmoniteScala3Version   = "3.3.0"
...
object Deps {
  ...
  def ammonite = ivy"com.lihaoyi:::ammonite:3.0.0-M0-49-151446c5"
  def asm      = ivy"org.ow2.asm:asm:9.5"
  // Force using of 2.13 - is there a better way?
  def bloopConfig      = ivy"ch.epfl.scala:bloop-config_2.13:1.5.5"
  def bloopRifle       = ivy"io.github.alexarchambault.bleep:bloop-rifle_2.13:1.5.9-sc-1"
