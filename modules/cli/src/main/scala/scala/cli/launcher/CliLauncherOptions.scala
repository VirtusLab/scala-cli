...
/**
  ...
  * @param cliVersion The Scala CLI version
  * @param cliScalaVersion The version of Scala on which Scala CLI was published.
  * @param power whether to enable the use of power commands when called as ''scala''
  */
...
/**
  * It provides a CaseApp Parser with the [[CliLauncherOptions]] that parses the arguments of the command line $1 ??
  *
