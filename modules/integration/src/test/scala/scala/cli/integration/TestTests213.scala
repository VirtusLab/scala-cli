...
trait TestTests213 { this: TestTestDefinitions & Test213 & TestBuildServer =>
  if !usesBloop then
...
class TestTests213WithBloop
    extends TestTestDefinitions with Test213 with TestWithBloop with TestTests213

class TestTests213WithoutBloop
    extends TestTestDefinitions with Test213 with TestWithoutBloop with TestTests213 {
