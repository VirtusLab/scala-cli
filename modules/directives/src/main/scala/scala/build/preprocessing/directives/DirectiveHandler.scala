...
trait BuildRequirementsHandler[V](val constrains: DirectiveConstrains[V])
    extends ConstraindDirectiveHandler[BuildRequirements, V]
...
object UsingDirectiveError {
  ...
  object NoValueProvided extends Kind:
    def apply(types: Seq[DirectiveValue[_]], value: Option[Value[_]] = None)(using
...
trait ConstraindDirectiveHandler[T, V] extends DirectiveHandler[T] {
