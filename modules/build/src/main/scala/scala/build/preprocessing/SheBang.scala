...
object SheBang {
  ...
  /** Returns the shebang section, the content without the shebang section, and newLine */
  ...
  /** Returns blanked shebang section, content without shebang section, and newLine */
