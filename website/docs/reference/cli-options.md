...
Version of SBT to be used for the export (2.0.1 by default)
...
Pass scalafmt version before running it (3.11.3 by default). If passed, this overrides whatever value is configured in the .scalafmt.conf file.
