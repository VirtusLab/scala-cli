...
If Scala CLI was installed via installation script you can uninstall it with:
...
If Scala CLI was installed via installer you can uninstall it in Cotrol Panel.
