...
```
You now have scala-cli installed in your system. Scala CLI is installed as a JAR rather than a native binary, and so it has a slightly higher startup time.
