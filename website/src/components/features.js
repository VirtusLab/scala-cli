...
const FeatureList = [
    <Feature image="img/envs.gif" title="Scala versions, dependencies and JVMs" 
      key="versions" education="true" simple_projects="true" scripting="true" prototyping="true"> 
      <p>
    ...
    <Feature image="img/envs.gif" title="Universal tool" key="universal" 
      simple_projects="true" scripting="true" prototyping="true">
      <p>
    ...
    <Feature 
      ...
      title="We do not call Scala-cli a build tool" key="buildtool" simple_projects="true">
        <p>
